...
export class HubScene extends Phaser.Scene {
    ...
    findNearbyTarget() {
        const distanceToMaya = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.mayaZone.x, this.mayaZone.y);
        if (distanceToMaya < 100) {
            return 'maya';
        }
        const distanceToBrightPath = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.brightPathZone.x, this.brightPathZone.y);
