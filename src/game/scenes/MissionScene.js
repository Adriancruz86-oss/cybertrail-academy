...
export class MissionScene extends Phaser.Scene {
    ...
    create() {
        ...
        mission.activity.options.forEach((option, index) => {
            ...
            optionContainer.setInteractive(new Phaser.Geom.Rectangle(-310, -32, 620, 64), Phaser.Geom.Rectangle.Contains, true);
    ...
    handleSelection(option) {
        ...
        this.attempted = true;
        this.disableOptions();
        const resultText = this.children.getByName('resultText');
        ...
        continueButton.setInteractive(new Phaser.Geom.Rectangle(-130, -28, 260, 56), Phaser.Geom.Rectangle.Contains, true);
    ...
    disableOptions() {
        this.optionButtons.forEach((button) => {
            ...
            const bg = button.list.find((child) => child instanceof Phaser.GameObjects.Rectangle);
            if (bg) {
...
//# sourceMappingURL=MissionScene.js.map