...
describe('mission completion integration', () => {
  it('completes missions 1-12, unlocks concepts, and reaches competency across distinct contexts', () => {
    ...
    expect(state.completedMissions).toEqual([
      'splus-c1-m01', 'splus-c1-m02', 'splus-c1-m03', 'splus-c1-m04', 'splus-c1-m05', 'splus-c1-m06',
      'splus-c1-m07', 'splus-c1-m08', 'splus-c1-m09', 'splus-c1-m10', 'splus-c1-m11', 'splus-c1-m12'
    ])
